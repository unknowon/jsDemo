    ...
    <div class="container" style="min-width: 1090px !important;">
        <article class="page-container">
            <form class="form form-horizontal" id="form-article-add">
                <input type="hidden" name="action" value="addSubmit2"/>
                ...
                <div class="row cl">
                    <table  class="table  table-border table-bordered  radius table-striped table-hover" style="margin: 10px;background: white">
                        ...
                        <tr>
                            ...
                            <td rowspan="5" colspan="3" class="text-c"><h1 style="text-align: center">毕节市七星关区服务业、医院节水用水月报表</h1></td>
                        ...
                        <tr>
                            <td colspan="3" class="text-r">职工(居民)人数(人)</td>
                            <td class="text-c">2</td>
                            <td><input class="input-text" id="input1" name="input1" placeholder="请输入职工(居民)人数(人)" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">床位或座位数</td>
                            <td class="text-c">3</td>
                            <td><input class="input-text" id="input2" name="input2" placeholder="请输入床位或座位数" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">服务或门诊人数</td>
                            <td class="text-c">4</td>
                            <td><input class="input-text" id="input3" name="input3" placeholder="请输入服务或门诊人数" /></td>
                        </tr>
                        <tr>
                            <td rowspan="4" class="text-r">产值（万元）</td>
                            <td colspan="2" class="text-r">本季度</td>
                            <td class="text-c">5</td>
                            <td><input class="input-text" id="input4" name="input4" placeholder="请输入本季度累计产值（万元）" /></td>
                        </tr>
                        <tr>
                            <td class="text-r" colspan="2">本年累计</td>
                            <td class="text-c">6</td>
                            <td><input class="input-text" id="input5" name="input5" placeholder="请输入本年累计产值（万元）" /></td>
                        </tr>
                        <tr>
                            <td rowspan="2" class="text-r">增加值</td>
                            <td class="text-r">本季度</td>
                            <td class="text-c">7</td>
                            <td><input class="input-text" id="input6" name="input6" placeholder="请输入本季度累计增加产值（万元）" /></td>
                        </tr>
                        <tr>
                            <td class="text-r" class="text-r">本年累计</td>
                            <td class="text-c">8</td>
                            <td><input class="input-text" id="input7" name="input7" placeholder="请输入本年累计增加产值（万元）" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">月用水定额</td>
                            <td class="text-c">9</td>
                            <td><input class="input-text" id="input8" name="input8" placeholder="请输入月用水定额" /></td>
                        </tr>
                        <tr>
                            <td class="text-r" colspan="3">水源种类</td>
                            <td class="text-c">10</td>
                            <td><input class="input-text" id="input9" name="input9" placeholder="请输入水源种类" /></td>
                        </tr>
                        <tr>
                            <td rowspan="3" class="text-r">新水量（米3）</td>
                            <td colspan="2" class="text-r">本月用水量（立方米）</td>
                            <td class="text-c">11</td>
                            <td><input class="input-text" id="input10" name="input10" placeholder="请输入本月用新水量" /></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-r">非常规水利用量（立方米）</td>
                            <td class="text-c">12</td>
                            <td><input class="input-text" id="input11" name="input11" placeholder="请输入非常规水利用量（立方米）" /></td>
                        </tr>
                        <tr>
                            <td colspan="2" class="text-r">本年累计（立方米）</td>
                            <td class="text-c">13</td>
                            <td><input class="input-text" id="input12" name="input12" placeholder="请输入本年累计新水量（立方米）" /></td>
                        </tr>
                        <tr>
                            <td colspan="2" rowspan="2" class="text-r">重复利用
                                水量（米3）</td>
                            <td class="text-r" width="100" style="white-space: nowrap">本月</td>
                            <td class="text-c">14</td>
                            <td><input class="input-text" id="input13" name="input13" placeholder="请输入本月累计重复利用水量" /></td>
                        </tr>
                        <tr>
                            <td class="text-r">本年累计</td>
                            <td class="text-c">15</td>
                            <td><input class="input-text" id="input14" name="input14" placeholder="请输入本年累计重复利用水量（米3）" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">重复利用率%(自动计算，不需要填写)</td>
                            <td class="text-c">16</td>
                            <td><input class="input-text" id="input15" name="input15" readonly placeholder="请输入重复利用率%" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">备注</td>
                            <td class="text-c">17</td>
                            <td width="600"><input class="input-text" id="input16" name="input16" placeholder="请输入备注" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">填报单位(章)</td>
                            <td class="text-c">18</td>
                            <td width="600"><input class="input-text" id="input17" name="input17" placeholder="请输入填报单位" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">行业号</td>
                            <td class="text-c">19</td>
                            <td width="600"><input class="input-text" id="input18" name="input18" placeholder="请输入行业号" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">系统号</td>
                            <td class="text-c">20</td>
                            <td width="600"><input class="input-text" id="input19" name="input19" placeholder="请输入系统号" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">填报日期</td>
                            <td class="text-c">21</td>
                            <td width="600"><input class="input-text" id="input20" name="input20" placeholder="请输入填报日期" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">单位节水管理部门</td>
                            <td class="text-c">22</td>
                            <td width="600"><input class="input-text" id="input21" name="input21" placeholder="请输入单位节水管理部门" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">电话</td>
                            <td class="text-c">23</td>
                            <td width="600"><input class="input-text" id="input22" name="input22" placeholder="请输入电话" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">填表人</td>
                            <td class="text-c">24</td>
                            <td width="600"><input class="input-text" id="input23" name="input23" placeholder="请输入填表人" /></td>
                        </tr>
                        <tr>
                            <td colspan="3" class="text-r">水表号</td>
                            <td class="text-c">25</td>
                            <td width="600"><input class="input-text" id="input24" name="input24" placeholder="请输入水表号" /></td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    $("#input10").on('keyup', function () {
        if ((parseFloat($("#input10").val())+parseFloat($("#input11").val()))>0&&parseFloat($(this).val())>0)
        {
            $("#input15").attr("value",(parseFloat($("#input13").val()/(parseFloat($("#input10").val())+parseFloat($("#input11").val()))))*100);
        }
    });
    $("#input11").on('keyup', function () {
        if ((parseFloat($("#input10").val())+parseFloat($("#input11").val()))>0&&parseFloat($(this).val())>0)
        {
            $("#input15").attr("value",(parseFloat($("#input13").val()/(parseFloat($("#input10").val())+parseFloat($("#input11").val()))))*100);
        }
    });
    $("#input13").on('keyup', function () {
        if ((parseFloat($("#input10").val())+parseFloat($("#input11").val()))>0&&parseFloat($(this).val())>0)
        {
            $("#input15").attr("value",(parseFloat($("#input13").val()/(parseFloat($("#input10").val())+parseFloat($("#input11").val()))))*100);
        }

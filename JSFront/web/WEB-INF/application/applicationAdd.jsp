                            ...
                            <li>
                                ...
                                <form class="form form-horizontal" id="form-article-add">
                                    ...
                                    <div class="row cl">
                                        ...
                                        <div class="formControls col-xs-8 col-sm-9">
                                            <select id="shenqingtype" name="type" class="select">
                                                <option value="0" class="select-option">请先选择类型</option>
                                                <option value="1" class="select-option">增加用水量</option>
                                                <option value="2" class="select-option">降低用水量</option>
                                                <option value="3" class="select-option">停止用水</option>
                                            </select>
                                        </div>
                                    </div>

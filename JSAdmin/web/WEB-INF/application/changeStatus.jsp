    ...
    <div class="Hui-article">
        ...
        <div class="pd-20">
            ...
            <form action="" method="post" class="form form-horizontal" id="form-add">
                <input type="hidden" name="action" value="changeStatusSubmit"/>
                <input type="hidden" name="id" value="${application.id}"/>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-2">是否通过：</label>
                    <div class="formControls col-xs-8 col-sm-9">
                        <select id="onetype" name="onetype" class="select">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <textarea style="width: 100%;height: 200px"  id="onereason" name="oneContent"></textarea>
                    </div>
                </div>
                <br/>

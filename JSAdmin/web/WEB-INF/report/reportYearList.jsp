...
<div class="pd-20">
    ...
    <br/>
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a class="btn btn-primary radius" href="<%=ctxPath%>/Report?action=downloadMonthReport"><i class="Hui-iconfont">&#xe674;</i> 下载当年报表</a></span> </div>
    <br/>

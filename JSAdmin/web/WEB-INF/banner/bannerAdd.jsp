...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        <input type="hidden" name="action" value="bannerAddSubmit"/>

        <div class="row cl">
            <label class="form-label col-2">描述：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="" name="bannerDesc">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <input value="" type="hidden" name="bannerUrl" id="goods_thumb"/>
        </div>

    ...
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="${banner.bannerDesc}" placeholder="" id="" name="bannerDesc">
            </div>
        </div>
                ...
                <div class="uploader-thum-container">
                    <div class="layui-upload">
                        ...
                        <div class="layui-upload-list">
                            <img class="layui-upload-img" src="<%=ctxPath%>/${banner.bannerUrl}" style="width: 200px;height: 200px" id="demo1">
                            <p id="demoText"></p>
                        </div>
                    </div>
                </div>
            </div>
            <input value="${banner.bannerUrl}" type="hidden" name="bannerUrl" id="goods_thumb"/>
        </div>

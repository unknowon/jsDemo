...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-article-add">
        <input type="hidden" name="action" value="articleAddSubmit"/>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" value="" placeholder="" id="" name="articleKeyWord">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">文章描述：</label>
            <div class="formControls col-10">
                <textarea name="articleDesc" cols="" rows="" class="textarea"  placeholder="说点什么..." datatype="*0-500" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,500)"></textarea>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-2">
                <input type="text" class="input-text" value="" placeholder="" id="" name="articleAuthor">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <script id="editor" name="articleContent" type="text/plain" style="width:100%;height:400px;"></script></div>
        </div>
